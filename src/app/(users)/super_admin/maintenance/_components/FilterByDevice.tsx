...
const FilterByDevice = () => {
    ...
    return (
        <div className='flex flex-col md:flex-row justify-between  gap-8 p-6 bg-[#FFFFFF] dark:bg-[#262629] rounded-2xl'>
            <div className='flex gap-2 '>
                ...
                <div className='flex flex-col gap-1 justify-center border-r-[1px] border-[#1717170D] pr-8'>
                    <p className='lg:text-[28px] text-xl text-[#171717] dark:text-white leading-8 font-semibold'>Sungrow3</p>
                    <div className='flex gap-3 items-center justify-center'>
                        <p className='lg:text-sm text-xs text-[#686868] dark:text-[#FFFFFFCC] font-medium'>
                            sungrow_141413
                        </p>
                        <div className='flex gap-1.5 items-center'>
                            <p className='w-2 h-2 bg-[#3FC43A] rounded-full'></p>
                            <span className='text-[#3FC43A] text-xs lg:text-sm font-medium'>Active</span>
                        </div>
                    </div>
                </div>
            ...
            <div className='flex  gap-2 flex-col justify-center border-r-[1px] border-[#1717170D] pr-8'>
                ...
                <p className='text-base lg:text-lg text-[#171717] dark:text-white leading-8 font-semibold'>MIMOS KHTP</p>
            </div>
            <div className='flex  gap-2 flex-col justify-center border-r-[1px] border-[#1717170D] pr-8'>
                ...
                <p className='text-base lg:text-lg text-[#171717] dark:text-white leading-8 font-semibold'>238 kWh</p>

            </div>
            <div className='flex  gap-2  flex-start md:justify-center items-center'>
                <p className='text-xs lg:text-sm  whitespace-nowrap text-[#686868] dark:text-[#FFFFFFCC] font-medium'>
                    Select Device
                </p>
                <form className="md:w-[353px] w-[200px] ">
