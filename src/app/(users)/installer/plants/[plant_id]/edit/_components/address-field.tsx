...
export default function AddressField({
  ...
  // console.log(form.getValues("coordinates"));
  ...
  useEffect(() => {
    setPosition({
      lat: form.getValues("coordinates.lat"),
      lng: form.getValues("coordinates.lng"),
    });
    setIsMarkerOn(true);
  }, [form.getValues("coordinates.lat"), form.getValues("coordinates.lng")]);
